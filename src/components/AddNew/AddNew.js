          ...
          <Form className="add-new__form-content" id="form-add-new">
            <Row className="mb-3 add-new__form-content__row">
              ...
              <Form.Group as={Col} controlId="formGridEmail">
                ...
                <Form.Control type="number" placeholder="Mínimo 2 caracteres" onChange={(e)=>setNumero(e.target.value)}/>
              </Form.Group>
            ...
            <Row className="mb-3 add-new__form-content__row">
              ...
              <Form.Group as={Col} controlId="formGridEmail">
                ...
                <Form.Control type="text" placeholder="Mínimo 6 caracteres" onChange={(e)=>setSerie(e.target.value)}/>
              </Form.Group>
